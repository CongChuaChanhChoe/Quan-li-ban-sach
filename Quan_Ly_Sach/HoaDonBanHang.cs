...
namespace Quan_Ly_Sach
{
    public partial class HDBSach : Form
    {
        ...
        public void loadData1()
        {
            ...
            string sQuerySach = @"select s.*,k.HoTenKH, n.TenNV,n.HoLot,hd.ThanhTien from Sach s, KhachHang k,NhanVien n ,Hoadon hd where  s.MaKH=k.MaKH and s.MaSach=n.MaSach and s.MaHD=hd.MaHD ";
            ...
            dgvTT6.Columns["TenSach"].HeaderText = "Tên Kho";
            ...
            dgvTT6.Columns["HoLot"].HeaderText = "Họ lót";
            dgvTT6.Columns["HoLot"].Width = 100;
...

        {
            ...
            int m = int.Parse(num.Value.ToString());
            int sum = 0;
            sum = m * l;
            this.txtTT.Text = sum.ToString();
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            if (dgvTT6.SelectedRows.Count > 0)
            {
                ...
                dr.Cells["ThanhTien"].Value = txtTT.Text;
            }
        }
        ...
        private void dgvTT6_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtTT.Text = dr.Cells["ThanhTien"].Value.ToString();
        }
