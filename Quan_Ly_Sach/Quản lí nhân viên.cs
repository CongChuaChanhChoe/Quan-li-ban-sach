...
namespace Quan_Ly_Sach
{
    public partial class Quản_lí_nhân_viên : Form
    {
        ...
        public void loadData()
        {
            ...
            dtgvQLNV.DataSource = ds.Tables["tblDSNhanVien"];
            ...
            cmThemNV.Parameters.Add("@SoDienThoai", SqlDbType.VarChar, 20, "SoDienThoai");
        ...
        private void dtgvQLNV_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmbCV.SelectedValue = dr.Cells["ChucVu"].Value.ToString();
            cmbCV.Text = dr.Cells["ChucVu"].Value.ToString();
            cmbTGLV.SelectedValue = dr.Cells["ThoiGianLamViec"].Value.ToString();
            cmbTGLV.Text = dr.Cells["ThoiGianLamViec"].Value.ToString();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataGridViewRow dr in this.dtgvQLNV.SelectedRows)
            {
                this.dtgvQLNV.Rows.RemoveAt(dr.Index);
            }
        }
